...
{
    document.getElementById("single_focus").src = 'http://localhost:8000/testing/' + label + '/' + id +'.png'
...
d3.json('http://localhost:8000/jsons/node_info_1.json', function(json) {all_nodes = json.node_info;});
...
// Draws the graph
d3.json('http://localhost:8000/jsons/graphFile.json', function(json) {
...
{   
    ...
    points = svg2.append("g")
      ...
      .data(node_info.nodes_coord)
      .enter().append("image")
      .attr("xlink:href", function(d, i){return 'http://localhost:8000/testing/' + d.label + '/' + d.id +'.png' })
      .attr("x", -8)
      .attr("y", -8)
      .attr("width", 28)
      .attr("height", 28)
